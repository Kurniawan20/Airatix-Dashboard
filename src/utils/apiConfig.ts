...
// Base API URLs
const AUTH_API_BASE_URL = 'http://localhost:8088/api';
const TRANSACTION_API_BASE_URL = 'http://localhost:8000/public';
...
export const API_ENDPOINTS = {
  ...
  TRANSACTIONS: {
    ...
    EVENT: (eventId: string | number, page: number = 1) => `${TRANSACTION_API_BASE_URL}/events/${eventId}/transactions?page=${page}`,
  }
};
